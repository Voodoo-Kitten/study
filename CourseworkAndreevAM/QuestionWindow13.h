...
namespace CourseWorkAndreevAM {
	...
	/// <summary>
	/// Summary for QuestionWindow13
	/// </summary>
	public ref class QuestionWindow13 : public System::Windows::Forms::Form
	{
	public:
		QuestionWindow13(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &QuestionWindow13::button1_Click);
			// 
			// label1
			// 
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		QuestionWindow14^ form = gcnew QuestionWindow14();
		form->Owner = this;
		form->Show();
		this->Hide();
	}
