...
namespace CourseWorkAndreevAM {
	...
	/// <summary>
	/// Summary for QuestionWindow9
	/// </summary>
	public ref class QuestionWindow9 : public System::Windows::Forms::Form
	{
	public:
		QuestionWindow9(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &QuestionWindow9::button1_Click);
			// 
			// textBox1
			// 
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		QuestionWindow10^ form = gcnew QuestionWindow10();
		form->Owner = this;
		form->Show();
		this->Hide();
	}
