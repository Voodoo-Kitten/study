...
namespace CourseWorkAndreevAM {
	...
	/// <summary>
	/// Summary for TheoryWindow
	/// </summary>
	public ref class TheoryWindow : public System::Windows::Forms::Form
	{
	public:
		TheoryWindow(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(TheoryWindow::typeid));
			...
			this->button1->Click += gcnew System::EventHandler(this, &TheoryWindow::button1_Click);
			// 
			// richTextBox1
			// 
			...
			this->richTextBox1->Size = System::Drawing::Size(784, 511);
			...
			this->Name = L"TheoryWindow";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Конспект";
