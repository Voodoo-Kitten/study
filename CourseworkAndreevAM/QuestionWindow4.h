...
namespace CourseWorkAndreevAM {
	...
	/// <summary>
	/// Summary for QuestionWindow4
	/// </summary>
	public ref class QuestionWindow4 : public System::Windows::Forms::Form
	{
	public:
		QuestionWindow4(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &QuestionWindow4::button1_Click);
			// 
			// label1
			// 
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		QuestionWindow5^ form = gcnew QuestionWindow5();
		form->Owner = this;
		form->Show();
		this->Hide();
	}
