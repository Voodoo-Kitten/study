...
namespace CourseWorkAndreevAM {
	...
	/// <summary>
	/// Summary for QuestionWindow12
	/// </summary>
	public ref class QuestionWindow12 : public System::Windows::Forms::Form
	{
	public:
		QuestionWindow12(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &QuestionWindow12::button1_Click);
			// 
			// label1
			// 
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		QuestionWindow13^ form = gcnew QuestionWindow13();
		form->Owner = this;
		form->Show();
		this->Hide();
	}
