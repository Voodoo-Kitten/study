...
namespace CourseWorkAndreevAM {
	...
	/// <summary>
	/// Summary for QuestionWindow11
	/// </summary>
	public ref class QuestionWindow11 : public System::Windows::Forms::Form
	{
	public:
		QuestionWindow11(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &QuestionWindow11::button1_Click);
			// 
			// label1
			// 
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		QuestionWindow12^ form = gcnew QuestionWindow12();
		form->Owner = this;
		form->Show();
		this->Hide();
	}
