...
namespace CourseWorkAndreevAM {
	...
	/// <summary>
	/// Summary for QuestionWindow14
	/// </summary>
	public ref class QuestionWindow14 : public System::Windows::Forms::Form
	{
	public:
		QuestionWindow14(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &QuestionWindow14::button1_Click);
			// 
			// label1
			// 
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		QuestionWindow15^ form = gcnew QuestionWindow15();
		form->Owner = this;
		form->Show();
		this->Hide();
	}
