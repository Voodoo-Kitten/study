...
namespace CourseWorkAndreevAM {
	...
	/// <summary>
	/// Summary for QuestionWindow5
	/// </summary>
	public ref class QuestionWindow5 : public System::Windows::Forms::Form
	{
	public:
		QuestionWindow5(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &QuestionWindow5::button1_Click);
			// 
			// label1
			// 
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		QuestionWindow6^ form = gcnew QuestionWindow6();
		form->Owner = this;
		form->Show();
		this->Hide();
	}
