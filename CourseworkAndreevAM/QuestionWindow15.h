...
namespace CourseWorkAndreevAM {
	...
	/// <summary>
	/// Summary for QuestionWindow15
	/// </summary>
	public ref class QuestionWindow15 : public System::Windows::Forms::Form
	{
	public:
		QuestionWindow15(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &QuestionWindow15::button1_Click);
			// 
			// label1
			// 
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		QuestionWindow16^ form = gcnew QuestionWindow16();
		form->Owner = this;
		form->Show();
		this->Hide();
	}
