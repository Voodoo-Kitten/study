...
namespace CourseWorkAndreevAM {
	...
	/// <summary>
	/// Summary for QuestionWindow10
	/// </summary>
	public ref class QuestionWindow10 : public System::Windows::Forms::Form
	{
	public:
		QuestionWindow10(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &QuestionWindow10::button1_Click);
			// 
			// textBox1
			// 
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		QuestionWindow11^ form = gcnew QuestionWindow11();
		form->Owner = this;
		form->Show();
		this->Hide();
	}
